...
class TeacherPortfolio extends StatefulWidget {
  ...
  TeacherPortfolio(
      ...
      this.id});
  @override
  _TeacherPortfolioState createState() => _TeacherPortfolioState();
}

class _TeacherPortfolioState extends State<TeacherPortfolio> {
  @override
      ...
      onWillPop: () {
        return showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: Text("Go back to Teachers Profile?"),
