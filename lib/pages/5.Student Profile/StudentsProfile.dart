...
class StudentsProfile extends StatefulWidget {
  ...
  StudentsProfile({@required this.username, this.imgUrl});
  @override
  _StudentsProfileState createState() => _StudentsProfileState();
}

class _StudentsProfileState extends State<StudentsProfile> {
  var url = "https://peaceful-everglades-79678.herokuapp.com/user/";
  var data;
